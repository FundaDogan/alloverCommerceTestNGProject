...
public class US_12_TC_03 {
    ...
    And Enter invalid firstname into First name box
    And Enter invalid lastname into Last name box
    ...
    Then Verify vendor should not be able to save billing address with invalid first and last name
     */
    ...
    public Object[][] vendorData(){
        ...
        Object [][] vendorCredentials = {
                ...
                {"12345*", "12345*", "100 William F Bell Street", "Richmond Hill", "L4S 0K1", "4204569874"},
        };
    ...
    public void TC_03(String firstname, String lastname, String street, String city, String zipcode, String phone){
        login();
        ...
        //     Verify vendor should not be able to save billing address with invalid first and last name
        String expectedMessage1 = "FIRST NAME is not a valid first name.";
        String actualMessage = vendorMyAccountPage.addressChangeSuccessMessage.getText();
